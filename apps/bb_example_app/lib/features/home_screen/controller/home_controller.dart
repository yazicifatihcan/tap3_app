...
class HomeController extends BaseControllerInterface {
  ...
  void onTapScanQr()=>context.pushNamed(MainRouteScreenEnums.scanQrScreen.name);
  ...
  void onTapMoreOptions(CardModel item){
    OptionSelectionBottomSheet(options: [
      OptionItemModel(title: 'Set card as new wallet',icon: const IconAssets().copyIcon),
      OptionItemModel(title: 'Show private key',icon: const IconAssets().copyIcon),
      OptionItemModel(title: 'Change password',icon: const IconAssets().copyIcon),
      OptionItemModel(title: 'Wipe the card',color: context.error,icon: const IconAssets().copyIcon),
